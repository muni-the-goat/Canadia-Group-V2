    ...
    <footer id="contact" className="bg-[#0B1C2D] text-white">
      <div className="max-w-[1200px] mx-auto px-6 lg:px-20 py-20">
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a
                ...
                aria-label="Canadia Group on LinkedIn"
              >
                <Linkedin size={20} />
              </a>
              <a
                ...
                rel="noopener noreferrer"
                className="w-10 h-10 bg-white/10 flex items-center justify-center rounded hover:bg-[#D4AF37] transition-colors duration-200"
                aria-label="Canadia Group on Facebook"
              >
                <Facebook size={20} />
              </a>
            </div>
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-lg mb-6 text-[#D4AF37] font-semibold">
              Quick Links
            </h4>
        ...
        <div className="pt-8 border-t border-white/10">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6">
              <a
                href="#"
                className="text-white/60 hover:text-[#D4AF37] transition-colors duration-200 text-sm"
              >
                Privacy Policy
              </a>
              <a
