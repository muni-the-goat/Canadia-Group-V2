...
export function Footer() {
  ...
  const subsidiaries = [
    ...
    'Canadia Investment Holding (CIH)',
  ];
        ...
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a href="#" className="w-10 h-10 bg-white/10 flex items-center justify-center rounded hover:bg-[#D4AF37] transition-colors duration-200">
                <Linkedin size={20} />
              </a>
              <a href="#" className="w-10 h-10 bg-white/10 flex items-center justify-center rounded hover:bg-[#D4AF37] transition-colors duration-200">
                <Facebook size={20} />
          ...
          <div>
            ...
            <ul className="space-y-3">
              {quickLinks.map((link) => (
                <li key={link}>
                  <a href="#" className="text-white/70 hover:text-[#D4AF37] transition-colors duration-200 text-base">
                    {link}
                  </a>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-3">
              {subsidiaries.map((company) => (
                <li key={company}>
                  <a href="#" className="text-white/70 hover:text-[#D4AF37] transition-colors duration-200 text-sm">
                    {company}
                  </a>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center">
                ...
                <a href="tel:+85523215000" className="text-white/70 hover:text-[#D4AF37] transition-colors duration-200 text-sm">
                  +855 23 215 000
                </a>
              </li>
              <li className="flex items-center">
                <Mail className="w-5 h-5 mr-3 flex-shrink-0" />
                <a href="mailto:info@canadiagroup.com" className="text-white/70 hover:text-[#D4AF37] transition-colors duration-200 text-sm">
